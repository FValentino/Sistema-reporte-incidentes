...
public class EmpleadoTecnicoController {
    ...
    //CRUD BASICO
    @GetMapping(value = "/empleados/tecnico", headers = "Accept=application/json")
    @ResponseBody
    public List<EmpleadoTecnico> mostrarTodos() {
        return this.empleado.mostrarTodos();
    }

    @PostMapping(value = "/empleados/tecnico/agregar", headers = "Accept=application/json")
    public void agregarEmpleado(@RequestBody EmpleadoTecnico empleado) {
        this.empleado.agregarEmpleadoTecnico(empleado);
    }

    @GetMapping(value = "/empleados/tecnico/{id}", headers = "Accept=application/json")
    @ResponseBody
    public Optional<EmpleadoTecnico> buscarEmpleado(@PathVariable long id) {
        return this.empleado.buscarEmpleadoTecnico(id);
    }

    @DeleteMapping(value = "/empleados/tecnico/eliminar/{id}", headers = "Accept=application/json")
    public void eliminarEmpleado(@PathVariable long id) {
        this.empleado.eliminarEmpleadoTecnico(id);
    }

    @PutMapping(value = "/empleados/tecnico/actualizar/{id}", headers = "Accept=application/json")
    ...
    @PutMapping(value = "/empleados/tecnico/actualizar/contraseña/{id}", headers = "Accept=application/json")
